...
function CartForm() {
    ...
    return (
        <div className="cart-filter-container">
            <div className="cart-filter-title">Looking for something ?</div>
            <div className="cart-filter-content">
                <input className="search-box"
                    value={query}
                    onChange={e => setQuery(e.target.value)}
                    type="search" placeholder="What do you need ?"
                />
                <div className="cart-search-details">
                    ...
                    <input className='cart-date-container' type="date" placeholder="Best before" selected={alimentDate} onChange={date => setAlimentDate(date)} />
                </div>
            </div>
        </div>
    );
